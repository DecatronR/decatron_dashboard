...
const Page = () => {
  ...
  return (
    <>
      <Head>
        <title>Property Conditions</title>
      </Head>
      <Box
        component="main"
        sx={{
      ...
      >
        <Container maxWidth="xl">
          <Stack spacing={3}>
            ...
            {isFormOpen && (
              <CreatePropertyConditionsForm
                onPropertyConditionsCreated={handlePropertyConditionsFetched}
              />
            )}
            {/* add the function to trigger submitonRoleCreated={handleRolesFetched}  */}
            <PropertyConditionsSearch
              propertyConditions={propertyConditionsData}
