...
const Page = () => {
  ...
  return (
    <>
      <Head>
        <title>Property Usage Types</title>
      </Head>
      <Box
        component="main"
        sx={{
        ...
        <Container maxWidth="xl">
          <Stack spacing={3}>
            <Stack direction="row" justifyContent="space-between" spacing={4}>
              <Stack spacing={1}>
                <Typography variant="h4">Property Usage Types</Typography>
            ...
            {isFormOpen && (
              <CreatePropertyUsageTypesForm
                onPropertyUsageTypeCreated={handlePropertyUsageTypesFetched}
              />
            )}
            {/* add the function to trigger submitonRoleCreated={handleRolesFetched}  */}
            <PropertyUsageTypesSearch
              propertyUsageTypes={propertyUsageTypesData}
